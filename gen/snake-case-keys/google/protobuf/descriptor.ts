...
export const FieldDescriptorProto = {
  fromJSON(object: any): FieldDescriptorProto {
    return {
      ...
      typeName: isSet(object.type_name) ? String(object.type_name) : "",
      extendee: isSet(object.extendee) ? String(object.extendee) : "",
      defaultValue: isSet(object.default_value)
        ? String(object.default_value)
        : "",
      oneofIndex: isSet(object.oneof_index) ? Number(object.oneof_index) : 0,
      jsonName: isSet(object.json_name) ? String(object.json_name) : "",
      options: isSet(object.options)
...
export const MethodDescriptorProto = {
  fromJSON(object: any): MethodDescriptorProto {
    return {
      name: isSet(object.name) ? String(object.name) : "",
      inputType: isSet(object.input_type) ? String(object.input_type) : "",
      outputType: isSet(object.output_type) ? String(object.output_type) : "",
      options: isSet(object.options)
...
export const FileOptions = {
  fromJSON(object: any): FileOptions {
    return {
      ...
      goPackage: isSet(object.go_package) ? String(object.go_package) : "",
  ...
  fromJSON(object: any): MessageOptions {
    return {
      ...
      noStandardDescriptorAccessor: isSet(
        ...
        : false,
      deprecated: isSet(object.deprecated) ? Boolean(object.deprecated) : false,
      mapEntry: isSet(object.map_entry) ? Boolean(object.map_entry) : false,
      uninterpretedOption: Array.isArray(object?.uninterpreted_option)
        ? object.uninterpreted_option.map((e: any) =>
            UninterpretedOption.fromJSON(e)
          )
  ...
  fromJSON(object: any): UninterpretedOption {
    return {
      ...
      negativeIntValue: isSet(object.negative_int_value)
        ...
        : "0",
      doubleValue: isSet(object.double_value) ? Number(object.double_value) : 0,
...
export const UninterpretedOption_NamePart = {
  fromJSON(object: any): UninterpretedOption_NamePart {
    return {
      namePart: isSet(object.name_part) ? String(object.name_part) : "",
  ...
  fromJSON(object: any): GeneratedCodeInfo_Annotation {
    return {
      path: Array.isArray(object?.path)
        ? object.path.map((e: any) => Number(e))
        : [],
      sourceFile: isSet(object.source_file) ? String(object.source_file) : "",
